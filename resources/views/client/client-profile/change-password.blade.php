...
<div class="relative min-h-screen bg-gradient-to-br from-[#fdf7f2] to-[#f5e8d9] overflow-hidden">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute top-20 left-20 text-7xl opacity-10 transform rotate-12">🔒</div>
        <div class="absolute bottom-20 right-20 text-7xl opacity-10 transform -rotate-12">🔑</div>
        <div class="absolute top-40 right-40 text-6xl opacity-10">🛡️</div>
        <div class="absolute bottom-40 left-40 text-6xl opacity-10">🔐</div>
        <div class="absolute top-60 left-60 text-5xl opacity-10">🍽️</div>
    ...
    <div class="relative z-10 max-w-2xl mx-auto mt-24 md:mt-32 px-4 mb-20">
        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20 relative overflow-hidden">
            ...
            <!-- Change Password Form with enhanced styling -->
            <form action="{{ route('client.password.update') }}" method="POST" class="space-y-6 relative">
                @csrf
